...
var newDatabaseName = 'fauxton-selenium-tests-replication';
var helpers = require('../../../../../test/nightwatch_tests/helpers/helpers.js');

const destroyDB = (client, done) => {
  var nano = helpers.getNanoInstance(client.globals.test_settings.db_url);
  nano.db.destroy(newDatabaseName, () => { done(); });
};

module.exports = {

  before: destroyDB, // just in case the test failed on prev execution
  after: destroyDB,
